...
#               curl -s "https://api.telegram.org/bot${BOT_TOKEN}/sendMessage?chat_id=-1001172296864&text=File Not Found"
                echo `echo
                java_execute()
{
...
copy_execute
java_execute
EXIT_ERROR > $errorfilePath$errorfileName`
